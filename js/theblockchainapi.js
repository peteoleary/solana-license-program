...
async function test_blockchain_api() {
  ...
  APIKeyID.apiKey = process.env['BLOCKCHAIN_API_KEY_ID'];

  let APISecretKey = defaultClient.authentications['APISecretKey'];
  APISecretKey.apiKey = process.env['BLOCKCHAIN_API_SECRET_KEY'];
  ...
  nftMintRequest.network = network;
...
if (require.main === module) {
  ...
  module.exports = test_blockchain_api
}